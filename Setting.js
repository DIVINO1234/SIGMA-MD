...
global.owner = process.env.OWNER_NUMBER  || '2348133771232' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "2348133771232" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"໓iงiຖē",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '໓iงiຖē sɪɢᴍᴀ-ᴍᴅ❤️',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `໓iงiຖē`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'sɪɢᴍᴀ-ᴍᴅ',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "໓iงiຖē" ,          // ADD YOUR STICKER PACKNAME
  ...
  antibadwords_values: process.env.ANTI_BAD_WORDS || 'xxx',   // IT WILL TAKES ACTIONS WHO SENDS THESE BAD WORDS
